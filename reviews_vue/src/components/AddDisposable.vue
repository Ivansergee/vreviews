    ...
    <div class="column is-6 is-offset-3">
      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="field">
          ...
          <p class="help">Название без названия бренда</p>
        </div>
        ...
        <div class="field">
          ...
          <p class="help">Описание устройства</p>
        </div>
        ...
        <div class="field" v-if="options">
          <label><span class="subtitle">Объем жидкости</span></label>
          <br />
          <div class="control">
        ...
        <div class="field">
          ...
          <p class="help">Добавьте фото устройства и выберите участок, который будет использован для превью. Для зума используйте колесико мыши или стандартный жест на смартфоне.</p>
        </div>
